...
1. **问题部分**（0-0.5秒）：直接显示问题，中间的关键词用黄色高亮
2. **学霸文字**（0.5-1秒）：显示学霸的文字回答 + 魔法音效
3. **学霸图片**（1-2秒）：显示学霸回答的图片
4. **我的标签**（2-3秒）：显示"我："标签（金色发光）
5. **我的回答**（3秒-结束）：显示我的回答图片/视频 + 反转音效

## 动态时长

- 如果"我的回答"视频 ≤ 1秒：总时长 = 4秒
- 如果"我的回答"视频 > 1秒：总时长 = 3秒 + 视频完整时长
- 图片类型默认显示1秒
